...
},{"../core/createError":9,"./../core/settle":12,"./../helpers/btoa":16,"./../helpers/buildURL":17,"./../helpers/cookies":19,"./../helpers/isURLSameOrigin":21,"./../helpers/parseHeaders":23,"./../utils":25,"_process":388}],3:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":2,"./adapters/xhr":2,"./helpers/normalizeHeaderName":22,"./utils":25,"_process":388}],15:[function(require,module,exports){
'use strict';
...
},{"global/document":355,"hyperx":358,"on-load":385}],29:[function(require,module,exports){
...
},{"assert":384,"global/document":355,"global/window":356}],386:[function(require,module,exports){
(function (process){
...
},{"isarray":381}],388:[function(require,module,exports){
...
},{"./is-object":390,"./request-base":391,"./response-base":392,"./should-retry":393,"component-emitter":30}],390:[function(require,module,exports){
/**
...
},{"./update-events.js":398,"bel":28,"morphdom":383}],398:[function(require,module,exports){
module.exports = [
...
var el = yo(_templateObject, translate.message('footer.language'), lang.bind(null, 'es'), translate.message('spanish'), lang.bind(null, 'en-US'), translate.message('english'));
...
var nav = yo(_templateObject, translate.message('logout'));
...
},{"../translate":413,"empty-element":354,"yo-yo":397}],401:[function(require,module,exports){
'use strict';

var _webcamjs = require('webcamjs');
...
page('/', header, loading, loadPictures, function (context, next) {
    ...
    var cancelButton = $('#cancelPicture');
    ...
    $('#modalCamara').modal({
        ready: function ready() {
            _webcamjs2.default.attach('#camara-input');
            shootButton.click(function (ev) {
                _webcamjs2.default.snap(function (data_uri) {
                    ...
                    uploadButton.click(function () {
                        ...
                        $('#picture-cards').prepend((0, _pictureCard2.default)(pic));
                        reset();
    ...
    return regeneratorRuntime.async(function loadPictures$(_context) {
        while (1) {
            switch (_context.prev = _context.next) {
                ...
                case 3:
                    context.pictures = _context.sent;
...
},{"../header":400,"../picture-card":406,"./template":402,"axios":1,"empty-element":354,"page":386,"superagent":389,"title":395,"webcamjs":396}],402:[function(require,module,exports){
'use strict';
...
module.exports = function (pictures) {
    var el = yo(_templateObject, subirImagen, translate('upload-picture'), changeHide, translate('upload'), cancel, pictures.map(function (pic) {
        return picture(pic);
    }));
...
},{"../layout":405,"../picture-card":406,"../translate":413,"superagent":389,"yo-yo":397}],403:[function(require,module,exports){
'use strict';
...
},{"./footer":399,"./header":400,"./homepage":401,"./signin":407,"./signup":409,"./user-page":414,"babel-polyfill":26,"page":386}],404:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['<div class="container landing">\n            <div class="row">\n                <div class="col s10 push-s1">\n                    <div class="row">\n                        <div class="col m5 hide-on-small-only">\n                            <figure>\n                                <img src="images/IMG_15999.jpg" class="iphone" alt="">\n                            </figure>\n                        </div>\n                        ', '\n                    </div>\n                </div>\n            </div>\n        </div>'], ['<div class="container landing">\n            <div class="row">\n                <div class="col s10 push-s1">\n                    <div class="row">\n                        <div class="col m5 hide-on-small-only">\n                            <figure>\n                                <img src="images/IMG_15999.jpg" class="iphone" alt="">\n                            </figure>\n                        </div>\n                        ', '\n                    </div>\n                </div>\n            </div>\n        </div>']);
...
},{"yo-yo":397}],405:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(picture) {
    ...
    function render(pic) {
        return yo(_templateObject, pic.liked ? 'liked' : '', pic.url, like.bind(null, null, true), pic.likeHeart ? 'liked' : '', pic.user.username, pic.user.avatar, pic.user.username, like.bind(null, true), like.bind(null, false), translate.message('likes', { numPhotos: pic.likes }));
    }
...
},{"../translate":413,"moment":382,"yo-yo":397}],407:[function(require,module,exports){
'use strict';
...
var signinForm = yo(_templateObject, translate.message('signup.facebook'), translate.message('signup.facebook.movil'), translate.message('username.placeholder'), translate.message('password.placeholder'), translate.message('signin'), translate.message('signin.not-have-account'), translate.message('signup.call-to-action'));

module.exports = landing(signinForm);

},{"../landing":404,"../translate":413,"yo-yo":397}],409:[function(require,module,exports){
'use strict';
...
},{"./template":410,"empty-element":354,"page":386,"title":395}],410:[function(require,module,exports){
'use strict';
...
var signupForm = yo(_templateObject, translate.message('signup.subheading'), translate.message('signup.facebook'), translate.message('signup.facebook.movil'), translate.message('email.placeholder'), translate.message('fullname.placeholder'), translate.message('username.placeholder'), translate.message('password.placeholder'), translate.message('signup.call-to-action'), translate.message('signup.have-account'), translate.message('signin'));

module.exports = landing(signupForm);

},{"../landing":404,"../translate":413,"yo-yo":397}],411:[function(require,module,exports){
'use strict';

module.exports = {
    likes: '{numPhotos, plural, ' + '=0 {no likes}' + '=1 {# likes}' + 'other {# likes}}',
    'logout': 'Logout',
    'english': 'English',
    'spanish': 'Spanish',
    'signup.subheading': 'Signup to whatever',
    'signup.facebook': 'Signup with Facebook',
    'signup.facebook.movil': 'Signup',
    ...
    'signin': 'Signin',
    'signin.not-have-account': '¿Do not have an account?',
...
module.exports = {
    'likes': 'Usted {numPhotos, plural, ' + '=0 {no tiene me gusta}' + '=1 {tiene un me gusta}' + 'other {tiene # me gusta}}',
    'logout': 'Salir',
    'english': 'Ingles',
    'spanish': 'Español',
    'signup.subheading': 'Registrate para lo que sea',
    'signup.facebook': 'Iniciar sesión con Facebook',
    'signup.facebook.movil': 'Iniciar sesión',
...
},{"./en-US":411,"./es":412,"intl":376,"intl-messageformat":361,"intl-relativeformat":370,"intl-relativeformat/dist/locale-data/en.js":368,"intl-relativeformat/dist/locale-data/es.js":369,"intl/locale-data/jsonp/en-US.js":378,"intl/locale-data/jsonp/es.js":379}],414:[function(require,module,exports){
'use strict';
...
(0, _page2.default)('/:username', _header2.default, loadUser, function (context, next) {
    var main = document.getElementById('main-container');
    (0, _title2.default)('Piracte - ' + context.params.username);
    (0, _emptyElement2.default)(main).appendChild((0, _template2.default)(context.user));
});

(0, _page2.default)('/:username/:id', _header2.default, loadUser, function (context, next) {
    var main = document.getElementById('main-container');
    (0, _title2.default)('Piracte - ' + context.params.username);
    (0, _emptyElement2.default)(main).appendChild((0, _template2.default)(context.user));
    ...
    $('.modal').modal({
        complete: function complete() {
            (0, _page2.default)('/' + context.params.username);
...
},{"../header":400,"./template":415,"empty-element":354,"page":386,"title":395}],415:[function(require,module,exports){
'use strict';
...
var _templateObject = _taggedTemplateLiteral(['<div class="container">\n            <section class="row">\n                <div class="col s12 m4">\n                    <figure id="pic-profile">\n                        <img src="', '" class="responsive-img circle"/>\n                    </figure>\n                </div>\n                <div class="col s12 m8">\n                    <div class="title-profile">\n                        <h4>', '</h4>\n                        <a href="#" class="waves-effect waves-light btn">Le sigues</a>\n                        <span><i class="fa fa-ellipsis-h" aria-hidden="true"></i></span>\n                    </div>\n                    <p class="flow-text desc-profile">\n                        <strong>Superman</strong> The most recognized superhero in pop culture, Superman has been elevated to mythic folkhero status.\n                    </p>\n                    <div class="facts-profile">\n                        <label>\n                            <strong>1938</strong> Appearance\n                        </label>\n                        <label>\n                            <strong>995</strong> Comicbooks\n                        </label>\n                        <label>\n                            <strong>6</strong> Movies\n                        </label>\n                    </div>\n                </div>\n            </section>\n            <section class="row">\n                ', '\n            </section>\n        </div>'], ['<div class="container">\n            <section class="row">\n                <div class="col s12 m4">\n                    <figure id="pic-profile">\n                        <img src="', '" class="responsive-img circle"/>\n                    </figure>\n                </div>\n                <div class="col s12 m8">\n                    <div class="title-profile">\n                        <h4>', '</h4>\n                        <a href="#" class="waves-effect waves-light btn">Le sigues</a>\n                        <span><i class="fa fa-ellipsis-h" aria-hidden="true"></i></span>\n                    </div>\n                    <p class="flow-text desc-profile">\n                        <strong>Superman</strong> The most recognized superhero in pop culture, Superman has been elevated to mythic folkhero status.\n                    </p>\n                    <div class="facts-profile">\n                        <label>\n                            <strong>1938</strong> Appearance\n                        </label>\n                        <label>\n                            <strong>995</strong> Comicbooks\n                        </label>\n                        <label>\n                            <strong>6</strong> Movies\n                        </label>\n                    </div>\n                </div>\n            </section>\n            <section class="row">\n                ', '\n            </section>\n        </div>']),
    _templateObject2 = _taggedTemplateLiteral(['<div class="col s12 m4">\n                            <a href="/', '/', '" class="picture-container">\n                                <figure id="pic-profile">\n                                    <img src="', '" class = "picture responsive-img" />\n                                </figure>\n                                <div class="likes"><i class="fa fa-heart-o" aria-hidden="true"></i> ', '</div>\n                            </a>\n                            <div id="modal', '" class="modal modal-fixed-footer">\n                                <div class="modal-content">\n                                    <figure id="pic-profile">\n                                        <img src="', '" class = "responsive-img" />\n                                    </figure>\n                                </div>\n                                <div class="modal-footer">\n                                  <div class="btn btn-flat likes"><i class="fa fa-heart-o" aria-hidden="true"></i> ', '</div>\n                                </div>\n                            </div>\n                        </div>'], ['<div class="col s12 m4">\n                            <a href="/', '/', '" class="picture-container">\n                                <figure id="pic-profile">\n                                    <img src="', '" class = "picture responsive-img" />\n                                </figure>\n                                <div class="likes"><i class="fa fa-heart-o" aria-hidden="true"></i> ', '</div>\n                            </a>\n                            <div id="modal', '" class="modal modal-fixed-footer">\n                                <div class="modal-content">\n                                    <figure id="pic-profile">\n                                        <img src="', '" class = "responsive-img" />\n                                    </figure>\n                                </div>\n                                <div class="modal-footer">\n                                  <div class="btn btn-flat likes"><i class="fa fa-heart-o" aria-hidden="true"></i> ', '</div>\n                                </div>\n                            </div>\n                        </div>']);
...
function userPageTemplate(user) {
    var el = (0, _yoYo2.default)(_templateObject, user.avatar, user.username, user.pictures.map(function (picture) {
        return (0, _yoYo2.default)(_templateObject2, user.username, picture.id, picture.src, picture.likes, picture.id, picture.src, translate('likes', { numPhotos: picture.likes }));
    }));

    return (0, _layout2.default)(el);
}

},{"../layout":405,"../translate":413,"yo-yo":397}]},{},[403]);
