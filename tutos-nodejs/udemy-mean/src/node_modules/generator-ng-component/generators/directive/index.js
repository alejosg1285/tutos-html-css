...
var Generator = function (_Base) {
  ...
  _createClass(Generator, [{
    ...
    value: function writing() {
      ...
      var templateDir = _path2.default.join(this.sourceRoot(), 'directiveSimple');
      if (this.complex) {
        configName = 'directiveComplexTemplates';
        templateDir = _path2.default.join(this.sourceRoot(), 'directiveComplex');
      }

      var basePath = this.config.get('basePath') || '';
      this.htmlUrl = (0, _util.relativeUrl)(basePath, _path2.default.join(this.dir, this.name + '.html'));
      (0, _util.copyTemplates)(this, 'directive', templateDir, configName);
    }
  }]);
