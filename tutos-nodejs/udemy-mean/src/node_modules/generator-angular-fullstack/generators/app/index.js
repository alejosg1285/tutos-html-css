    ...
    get: function get() {
      return {
        ...
        checkForConfig: function checkForConfig() {
          ...
          var promise = this.options['skip-config'] ? _bluebird2.default.resolve({ skipConfig: true }) : this.prompt([{
            type: 'confirm',
            name: 'skipConfig',
          ...
          return promise.then(function (answers) {
            ...
            if (_this3.skipConfig) {
              ...
              _this3.templateExt = _this3.filters.pug ? 'pug' : 'html';
        ...
        clientPrompts: function clientPrompts() {
          ...
          return this.prompt([{
            ...
            when: function when(answers) {
              return answers.transpiler === 'babel';
            }
          }, {
            type: 'list',
            name: 'markup',
    ...
    get: function get() {
      return {
        generateProject: function generateProject() {
          ...
          var genDir = _path2.default.join(__dirname, '../../');

          var clientJsFilter = (0, _gulpFilter2.default)(['client/**/*.js'], { restore: true });
          this.registerTransformStream([clientJsFilter, (0, _gulpBabel2.default)({
          ...
          }), (0, _gulpEslint2.default)({
            fix: true,
            configFile: _path2.default.join(genDir, 'templates/app/client/.eslintrc(babel)')
          ...
          if (this.filters.ts) {
            (function () {
              var replacer = function replacer(contents) {
                modulesToFix.forEach(function (_ref2) {
                  var _ref3 = _slicedToArray(_ref2, 2),
                      moduleName = _ref3[0],
                      importName = _ref3[1];

                  contents = contents.replace('import ' + moduleName + ' from \'' + importName + '\'', 'const ' + moduleName + ' = require(\'' + importName + '\')');
                });
                return contents;
              };

              var modulesToFix = [['angular', 'angular'], ['ngCookies', 'angular-cookies'], ['ngResource', 'angular-resource'], ['ngSanitize', 'angular-sanitize'], ['uiRouter', 'angular-ui-router'], ['ngRoute', 'angular-route'], ['uiBootstrap', 'angular-ui-bootstrap'], ['ngMessages', 'angular-messages'], ['io', 'socket.io-client']];


              var tsFilter = (0, _gulpFilter2.default)(['client/**/*.ts'], { restore: true });
              _this8.registerTransformStream([tsFilter, (0, _gulpTap2.default)(function (file, t) {
                var contents = file.contents.toString();
          ...
          var serverJsFilter = (0, _gulpFilter2.default)(['server/**/*.js'], { restore: true });
