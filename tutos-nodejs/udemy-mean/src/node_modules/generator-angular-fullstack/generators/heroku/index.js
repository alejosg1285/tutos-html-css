...
var Generator = exports.Generator = function (_Base) {
  ...
  _createClass(Generator, [{
    ...
    value: function build() {
      ...
      var child = (0, _child_process.exec)('gulp build', function (err, stdout) {
        done();
      });
