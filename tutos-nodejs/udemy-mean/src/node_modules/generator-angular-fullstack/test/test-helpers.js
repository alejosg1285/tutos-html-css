...
function runCmd(cmd) {
  return new _bluebird2.default(function (resolve, reject) {
    (0, _child_process.exec)(cmd, { maxBuffer: 1024 * 500 }, function (err, stdout, stderr) {
      if (err) {
...
function assertOnlyFiles(expectedFiles) {
  ...
  var skip = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ['node_modules', 'bower_components'];
...
function runGen(prompts) {
  ...
  var gen = _yeomanTest2.default.run(require.resolve('../generators/app')).inTmpDir(function (dir) {
    ...
    var promises = [_fs2.default.symlinkAsync(__dirname + '/fixtures/node_modules', dir + '/node_modules')];
