...
var eslintCmd = _path3.default.join(TEST_DIR, '/fixtures/node_modules/.bin/eslint');
...
function eslintDir(dir, name, folder) {
  ...
  var regFiles = _fs2.default.readdirAsync(endpointDir).then(function (files) {
    ...
    return testFile(eslintCmd, _path3.default.join('./server/api/', folder, file));
  });
  ...
  var specFiles = _fs2.default.readdirAsync(endpointDir).then(function (files) {
    ...
    return testFile(eslintCmd + ' --env node,es6,mocha --global sinon,expect', _path3.default.join('./server/api/', folder, file));
  });
  ...
  describe('with a generated endpont \'foo\'', function () {
    ...
    beforeEach(function () {
      return runEndpointGen('foo', { config: config['generator-angular-fullstack'] }).then(function (_dir) {
        ...
        return _bluebird2.default.all([(0, _testHelpers.copyAsync)(_path3.default.join(genDir, '/.eslintrc'), './.eslintrc'), (0, _testHelpers.copyAsync)(_path3.default.join(genDir, '/server/.eslintrc'), './server/.eslintrc')]);
      });
    });
