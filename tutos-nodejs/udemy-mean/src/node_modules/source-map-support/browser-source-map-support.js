...
v,l){N=p("./source-map-support")},{"./source-map-support":19}],2:[function(p,v,l){},{}],3:[function(p,v,l){function b(g,m,c){if(!(this instanceof b))return new b(g,m,c);var y=typeof g;if("base64"===m&&"string"===y)for(g=g.trim?g.trim():g.replace(/^\s+|\s+$/g,"");0!==g.length%4;)g+="=";var a;if("number"===y)a=A(g);else if("string"===y)a=b.byteLength(g,m);else if("object"===y)a=A(g.length);else throw Error("First argument needs to be a number, array or string.");var f;b._useTypedArrays?f=b._augment(new Uint8Array(a)):
(f=this,f.length=a,f._isBuffer=!0);if(b._useTypedArrays&&"number"===typeof g.byteLength)f._set(g);else{var d=g;if(L(d)||b.isBuffer(d)||d&&"object"===typeof d&&"number"===typeof d.length)for(m=0;m<a;m++)b.isBuffer(g)?f[m]=g.readUInt8(m):f[m]=g[m];else if("string"===y)f.write(g,0,m);else if("number"===y&&!b._useTypedArrays&&!c)for(m=0;m<a;m++)f[m]=0}return f}function e(g,m,c){var y="";for(c=Math.min(g.length,c);m<c;m++)y+=String.fromCharCode(g[m]);return y}function k(g,m,c,a){a||(q("boolean"===typeof c,
"missing or invalid endian"),q(void 0!==m&&null!==m,"missing offset"),q(m+1<g.length,"Trying to read beyond buffer length"));a=g.length;if(!(m>=a))return c?(c=g[m],m+1<a&&(c|=g[m+1]<<8)):(c=g[m]<<8,m+1<a&&(c|=g[m+1])),c}function r(g,m,c,a){a||(q("boolean"===typeof c,"missing or invalid endian"),q(void 0!==m&&null!==m,"missing offset"),q(m+3<g.length,"Trying to read beyond buffer length"));a=g.length;if(!(m>=a)){var y;c?(m+2<a&&(y=g[m+2]<<16),m+1<a&&(y|=g[m+1]<<8),y|=g[m],m+3<a&&(y+=g[m+3]<<24>>>0)):
...
g.length))return g=r(g,m,c,!0),g&2147483648?-1*(4294967295-g+1):g}function h(g,m,c,a){a||(q("boolean"===typeof c,"missing or invalid endian"),q(m+3<g.length,"Trying to read beyond buffer length"));return J.read(g,m,c,23,4)}function n(g,m,c,a){a||(q("boolean"===typeof c,"missing or invalid endian"),q(m+7<g.length,"Trying to read beyond buffer length"));return J.read(g,m,c,52,8)}function t(g,m,c,a,f){f||(q(void 0!==m&&null!==m,"missing value"),q("boolean"===typeof a,"missing or invalid endian"),q(void 0!==
c&&null!==c,"missing offset"),q(c+1<g.length,"trying to write beyond buffer length"),H(m,65535));var y=g.length;if(!(c>=y))for(f=0,y=Math.min(y-c,2);f<y;f++)g[c+f]=(m&255<<8*(a?f:1-f))>>>8*(a?f:1-f)}function c(g,c,a,f,b){b||(q(void 0!==c&&null!==c,"missing value"),q("boolean"===typeof f,"missing or invalid endian"),q(void 0!==a&&null!==a,"missing offset"),q(a+3<g.length,"trying to write beyond buffer length"),H(c,4294967295));var m=g.length;if(!(a>=m))for(b=0,m=Math.min(m-a,4);b<m;b++)g[a+b]=c>>>
8*(f?b:3-b)&255}function f(g,c,a,f,b){b||(q(void 0!==c&&null!==c,"missing value"),q("boolean"===typeof f,"missing or invalid endian"),q(void 0!==a&&null!==a,"missing offset"),q(a+1<g.length,"Trying to write beyond buffer length"),z(c,32767,-32768));a>=g.length||(0<=c?t(g,c,a,f,b):t(g,65535+c+1,a,f,b))}function G(g,m,a,f,b){b||(q(void 0!==m&&null!==m,"missing value"),q("boolean"===typeof f,"missing or invalid endian"),q(void 0!==a&&null!==a,"missing offset"),q(a+3<g.length,"Trying to write beyond buffer length"),
z(m,2147483647,-2147483648));a>=g.length||(0<=m?c(g,m,a,f,b):c(g,4294967295+m+1,a,f,b))}function u(g,c,a,f,b){b||(q(void 0!==c&&null!==c,"missing value"),q("boolean"===typeof f,"missing or invalid endian"),q(void 0!==a&&null!==a,"missing offset"),q(a+3<g.length,"Trying to write beyond buffer length"),E(c,3.4028234663852886E38,-3.4028234663852886E38));a>=g.length||J.write(g,c,a,f,23,4)}function M(g,c,a,f,b){b||(q(void 0!==c&&null!==c,"missing value"),q("boolean"===typeof f,"missing or invalid endian"),
q(void 0!==a&&null!==a,"missing offset"),q(a+7<g.length,"Trying to write beyond buffer length"),E(c,1.7976931348623157E308,-1.7976931348623157E308));a>=g.length||J.write(g,c,a,f,52,8)}function I(g,c,a){if("number"!==typeof g)return a;g=~~g;if(g>=c)return c;if(0<=g)return g;g+=c;return 0<=g?g:0}function A(g){g=~~Math.ceil(+g);return 0>g?0:g}function L(g){return(Array.isArray||function(g){return"[object Array]"===Object.prototype.toString.call(g)})(g)}function C(g){return 16>g?"0"+g.toString(16):g.toString(16)}
function x(g){for(var c=[],a=0;a<g.length;a++){var f=g.charCodeAt(a);if(127>=f)c.push(g.charCodeAt(a));else{var b=a;55296<=f&&57343>=f&&a++;f=encodeURIComponent(g.slice(b,a+1)).substr(1).split("%");for(b=0;b<f.length;b++)c.push(parseInt(f[b],16))}}return c}function K(g){for(var c=[],a=0;a<g.length;a++)c.push(g.charCodeAt(a)&255);return c}function B(g,c,a,f){for(var m=0;m<f&&!(m+a>=c.length||m>=g.length);m++)c[m+a]=g[m];return m}function F(g){try{return decodeURIComponent(g)}catch(m){return String.fromCharCode(65533)}}
function H(g,c){q("number"===typeof g,"cannot write a non-number as a number");q(0<=g,"specified a negative value for writing an unsigned value");q(g<=c,"value is larger than maximum value for type");q(Math.floor(g)===g,"value has a fractional component")}function z(g,c,a){q("number"===typeof g,"cannot write a non-number as a number");q(g<=c,"value larger than maximum allowed value");q(g>=a,"value smaller than minimum allowed value");q(Math.floor(g)===g,"value has a fractional component")}function E(g,
c,a){q("number"===typeof g,"cannot write a non-number as a number");q(g<=c,"value larger than maximum allowed value");q(g>=a,"value smaller than minimum allowed value")}function q(g,c){if(!g)throw Error(c||"Failed assertion");}var D=p("base64-js"),J=p("ieee754");l.Buffer=b;l.SlowBuffer=b;l.INSPECT_MAX_BYTES=50;b.poolSize=8192;b._useTypedArrays=function(){try{var g=new ArrayBuffer(0),c=new Uint8Array(g);c.foo=function(){return 42};return 42===c.foo()&&"function"===typeof c.subarray}catch(y){return!1}}();
b.isEncoding=function(g){switch(String(g).toLowerCase()){case "hex":case "utf8":case "utf-8":case "ascii":case "binary":case "base64":case "raw":case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":return!0;default:return!1}};b.isBuffer=function(g){return!(null===g||void 0===g||!g._isBuffer)};b.byteLength=function(g,c){var a;g+="";switch(c||"utf8"){case "hex":a=g.length/2;break;case "utf8":case "utf-8":a=x(g).length;break;case "ascii":case "binary":case "raw":a=g.length;break;case "base64":a=D.toByteArray(g).length;
break;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":a=2*g.length;break;default:throw Error("Unknown encoding");}return a};b.concat=function(g,c){q(L(g),"Usage: Buffer.concat(list, [totalLength])\nlist should be an Array.");if(0===g.length)return new b(0);if(1===g.length)return g[0];var a;if("number"!==typeof c)for(a=c=0;a<g.length;a++)c+=g[a].length;var m=new b(c),f=0;for(a=0;a<g.length;a++){var d=g[a];d.copy(m,f);f+=d.length}return m};b.prototype.write=function(g,c,a,f){if(isFinite(c))isFinite(a)||
(f=a,a=void 0);else{var m=f;f=c;c=a;a=m}c=Number(c)||0;m=this.length-c;a?(a=Number(a),a>m&&(a=m)):a=m;f=String(f||"utf8").toLowerCase();switch(f){case "hex":c=Number(c)||0;f=this.length-c;a?(a=Number(a),a>f&&(a=f)):a=f;f=g.length;q(0===f%2,"Invalid hex string");a>f/2&&(a=f/2);for(f=0;f<a;f++)m=parseInt(g.substr(2*f,2),16),q(!isNaN(m),"Invalid hex string"),this[c+f]=m;b._charsWritten=2*f;g=f;break;case "utf8":case "utf-8":g=b._charsWritten=B(x(g),this,c,a);break;case "ascii":g=b._charsWritten=B(K(g),
this,c,a);break;case "binary":g=b._charsWritten=B(K(g),this,c,a);break;case "base64":g=b._charsWritten=B(D.toByteArray(g),this,c,a);break;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":for(var d,m=[],h=0;h<g.length;h++)d=g.charCodeAt(h),f=d>>8,d%=256,m.push(d),m.push(f);g=b._charsWritten=B(m,this,c,a);break;default:throw Error("Unknown encoding");}return g};b.prototype.toString=function(g,c,a){g=String(g||"utf8").toLowerCase();c=Number(c)||0;a=void 0!==a?Number(a):a=this.length;if(a===c)return"";
switch(g){case "hex":g=this.length;if(!c||0>c)c=0;if(!a||0>a||a>g)a=g;for(g="";c<a;c++)g+=C(this[c]);a=g;break;case "utf8":case "utf-8":var f=g="";for(a=Math.min(this.length,a);c<a;c++)127>=this[c]?(g+=F(f)+String.fromCharCode(this[c]),f=""):f+="%"+this[c].toString(16);a=g+F(f);break;case "ascii":a=e(this,c,a);break;case "binary":a=e(this,c,a);break;case "base64":a=0===c&&a===this.length?D.fromByteArray(this):D.fromByteArray(this.slice(c,a));break;case "ucs2":case "ucs-2":case "utf16le":case "utf-16le":a=
this.slice(c,a);c="";for(g=0;g<a.length;g+=2)c+=String.fromCharCode(a[g]+256*a[g+1]);a=c;break;default:throw Error("Unknown encoding");}return a};b.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};b.prototype.copy=function(g,c,a,f){a||(a=0);f||0===f||(f=this.length);c||(c=0);if(f!==a&&0!==g.length&&0!==this.length)if(q(f>=a,"sourceEnd < sourceStart"),q(0<=c&&c<g.length,"targetStart out of bounds"),q(0<=a&&a<this.length,"sourceStart out of bounds"),
q(0<=f&&f<=this.length,"sourceEnd out of bounds"),f>this.length&&(f=this.length),g.length-c<f-a&&(f=g.length-c+a),f-=a,100>f||!b._useTypedArrays)for(var m=0;m<f;m++)g[m+c]=this[m+a];else g._set(this.subarray(a,a+f),c)};b.prototype.slice=function(g,c){var a=this.length;g=I(g,a,0);c=I(c,a,a);if(b._useTypedArrays)return b._augment(this.subarray(g,c));for(var a=c-g,f=new b(a,void 0,!0),m=0;m<a;m++)f[m]=this[m+g];return f};b.prototype.get=function(a){console.log(".get() is deprecated. Access using array indexes instead.");
return this.readUInt8(a)};b.prototype.set=function(a,c){console.log(".set() is deprecated. Access using array indexes instead.");return this.writeUInt8(a,c)};b.prototype.readUInt8=function(a,c){c||(q(void 0!==a&&null!==a,"missing offset"),q(a<this.length,"Trying to read beyond buffer length"));if(!(a>=this.length))return this[a]};b.prototype.readUInt16LE=function(a,c){return k(this,a,!0,c)};b.prototype.readUInt16BE=function(a,c){return k(this,a,!1,c)};b.prototype.readUInt32LE=function(a,c){return r(this,
a,!0,c)};b.prototype.readUInt32BE=function(a,c){return r(this,a,!1,c)};b.prototype.readInt8=function(a,c){c||(q(void 0!==a&&null!==a,"missing offset"),q(a<this.length,"Trying to read beyond buffer length"));if(!(a>=this.length))return this[a]&128?-1*(255-this[a]+1):this[a]};b.prototype.readInt16LE=function(a,c){return d(this,a,!0,c)};b.prototype.readInt16BE=function(a,c){return d(this,a,!1,c)};b.prototype.readInt32LE=function(c,f){return a(this,c,!0,f)};b.prototype.readInt32BE=function(c,f){return a(this,
c,!1,f)};b.prototype.readFloatLE=function(a,c){return h(this,a,!0,c)};b.prototype.readFloatBE=function(a,c){return h(this,a,!1,c)};b.prototype.readDoubleLE=function(a,c){return n(this,a,!0,c)};b.prototype.readDoubleBE=function(a,c){return n(this,a,!1,c)};b.prototype.writeUInt8=function(a,c,f){f||(q(void 0!==a&&null!==a,"missing value"),q(void 0!==c&&null!==c,"missing offset"),q(c<this.length,"trying to write beyond buffer length"),H(a,255));c>=this.length||(this[c]=a)};b.prototype.writeUInt16LE=function(a,
c,f){t(this,a,c,!0,f)};b.prototype.writeUInt16BE=function(a,c,f){t(this,a,c,!1,f)};b.prototype.writeUInt32LE=function(a,f,b){c(this,a,f,!0,b)};b.prototype.writeUInt32BE=function(a,f,b){c(this,a,f,!1,b)};b.prototype.writeInt8=function(a,c,f){f||(q(void 0!==a&&null!==a,"missing value"),q(void 0!==c&&null!==c,"missing offset"),q(c<this.length,"Trying to write beyond buffer length"),z(a,127,-128));c>=this.length||(0<=a?this.writeUInt8(a,c,f):this.writeUInt8(255+a+1,c,f))};b.prototype.writeInt16LE=function(a,
c,b){f(this,a,c,!0,b)};b.prototype.writeInt16BE=function(a,c,b){f(this,a,c,!1,b)};b.prototype.writeInt32LE=function(a,c,f){G(this,a,c,!0,f)};b.prototype.writeInt32BE=function(a,c,f){G(this,a,c,!1,f)};b.prototype.writeFloatLE=function(a,c,f){u(this,a,c,!0,f)};b.prototype.writeFloatBE=function(a,c,f){u(this,a,c,!1,f)};b.prototype.writeDoubleLE=function(a,c,f){M(this,a,c,!0,f)};b.prototype.writeDoubleBE=function(a,c,f){M(this,a,c,!1,f)};b.prototype.fill=function(a,c,f){a||(a=0);c||(c=0);f||(f=this.length);
"string"===typeof a&&(a=a.charCodeAt(0));q("number"===typeof a&&!isNaN(a),"value is not a number");q(f>=c,"end < start");if(f!==c&&0!==this.length)for(q(0<=c&&c<this.length,"start out of bounds"),q(0<=f&&f<=this.length,"end out of bounds");c<f;c++)this[c]=a};b.prototype.inspect=function(){for(var a=[],c=this.length,f=0;f<c;f++)if(a[f]=C(this[f]),f===l.INSPECT_MAX_BYTES){a[f+1]="...";break}return"<Buffer "+a.join(" ")+">"};b.prototype.toArrayBuffer=function(){if("undefined"!==typeof Uint8Array){if(b._useTypedArrays)return(new b(this)).buffer;
for(var a=new Uint8Array(this.length),c=0,f=a.length;c<f;c+=1)a[c]=this[c];return a.buffer}throw Error("Buffer.toArrayBuffer not supported in this browser");};var w=b.prototype;b._augment=function(a){a._isBuffer=!0;a._get=a.get;a._set=a.set;a.get=w.get;a.set=w.set;a.write=w.write;a.toString=w.toString;a.toLocaleString=w.toString;a.toJSON=w.toJSON;a.copy=w.copy;a.slice=w.slice;a.readUInt8=w.readUInt8;a.readUInt16LE=w.readUInt16LE;a.readUInt16BE=w.readUInt16BE;a.readUInt32LE=w.readUInt32LE;a.readUInt32BE=
w.readUInt32BE;a.readInt8=w.readInt8;a.readInt16LE=w.readInt16LE;a.readInt16BE=w.readInt16BE;a.readInt32LE=w.readInt32LE;a.readInt32BE=w.readInt32BE;a.readFloatLE=w.readFloatLE;a.readFloatBE=w.readFloatBE;a.readDoubleLE=w.readDoubleLE;a.readDoubleBE=w.readDoubleBE;a.writeUInt8=w.writeUInt8;a.writeUInt16LE=w.writeUInt16LE;a.writeUInt16BE=w.writeUInt16BE;a.writeUInt32LE=w.writeUInt32LE;a.writeUInt32BE=w.writeUInt32BE;a.writeInt8=w.writeInt8;a.writeInt16LE=w.writeInt16LE;a.writeInt16BE=w.writeInt16BE;
a.writeInt32LE=w.writeInt32LE;a.writeInt32BE=w.writeInt32BE;a.writeFloatLE=w.writeFloatLE;a.writeFloatBE=w.writeFloatBE;a.writeDoubleLE=w.writeDoubleLE;a.writeDoubleBE=w.writeDoubleBE;a.fill=w.fill;a.inspect=w.inspect;a.toArrayBuffer=w.toArrayBuffer;return a}},{"base64-js":4,ieee754:5}],4:[function(p,v,l){(function(b){function e(b){b=b.charCodeAt(0);if(43===b||45===b)return 62;if(47===b||95===b)return 63;if(48>b)return-1;if(58>b)return b-48+52;if(91>b)return b-65;if(123>b)return b-97+26}var k="undefined"!==
typeof Uint8Array?Uint8Array:Array;b.toByteArray=function(b){function d(a){c[f++]=a}var a,h,n,t,c;if(0<b.length%4)throw Error("Invalid string. Length must be a multiple of 4");a=b.length;t="="===b.charAt(a-2)?2:"="===b.charAt(a-1)?1:0;c=new k(3*b.length/4-t);h=0<t?b.length-4:b.length;var f=0;for(a=0;a<h;a+=4)n=e(b.charAt(a))<<18|e(b.charAt(a+1))<<12|e(b.charAt(a+2))<<6|e(b.charAt(a+3)),d((n&16711680)>>16),d((n&65280)>>8),d(n&255);2===t?(n=e(b.charAt(a))<<2|e(b.charAt(a+1))>>4,d(n&255)):1===t&&(n=
e(b.charAt(a))<<10|e(b.charAt(a+1))<<4|e(b.charAt(a+2))>>2,d(n>>8&255),d(n&255));return c};b.fromByteArray=function(b){var d,a=b.length%3,h="",n,e;d=0;for(e=b.length-a;d<e;d+=3)n=(b[d]<<16)+(b[d+1]<<8)+b[d+2],n="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n&
63),h+=n;switch(a){case 1:n=b[b.length-1];h+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n>>2);h+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n<<4&63);h+="==";break;case 2:n=(b[b.length-2]<<8)+b[b.length-1],h+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n>>10),h+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n>>4&63),h+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(n<<
2&63),h+="="}return h}})("undefined"===typeof l?this.base64js={}:l)},{}],5:[function(p,v,l){l.read=function(b,e,k,r,d){var a;a=8*d-r-1;var h=(1<<a)-1,n=h>>1,t=-7;d=k?d-1:0;var c=k?-1:1,f=b[e+d];d+=c;k=f&(1<<-t)-1;f>>=-t;for(t+=a;0<t;k=256*k+b[e+d],d+=c,t-=8);a=k&(1<<-t)-1;k>>=-t;for(t+=r;0<t;a=256*a+b[e+d],d+=c,t-=8);if(0===k)k=1-n;else{if(k===h)return a?NaN:Infinity*(f?-1:1);a+=Math.pow(2,r);k-=n}return(f?-1:1)*a*Math.pow(2,k-r)};l.write=function(b,e,k,r,d,a){var h,n=8*a-d-1,t=(1<<n)-1,c=t>>1,f=
23===d?Math.pow(2,-24)-Math.pow(2,-77):0;a=r?0:a-1;var G=r?1:-1,u=0>e||0===e&&0>1/e?1:0;e=Math.abs(e);isNaN(e)||Infinity===e?(e=isNaN(e)?1:0,r=t):(r=Math.floor(Math.log(e)/Math.LN2),1>e*(h=Math.pow(2,-r))&&(r--,h*=2),e=1<=r+c?e+f/h:e+f*Math.pow(2,1-c),2<=e*h&&(r++,h/=2),r+c>=t?(e=0,r=t):1<=r+c?(e=(e*h-1)*Math.pow(2,d),r+=c):(e=e*Math.pow(2,c-1)*Math.pow(2,d),r=0));for(;8<=d;b[k+a]=e&255,a+=G,e/=256,d-=8);r=r<<d|e;for(n+=d;0<n;b[k+a]=r&255,a+=G,r/=256,n-=8);b[k+a-G]|=128*u}},{}],6:[function(p,v,l){function b(){}
p=v.exports={};p.nextTick=function(){if("undefined"!==typeof window&&window.setImmediate)return function(b){return window.setImmediate(b)};if("undefined"!==typeof window&&window.postMessage&&window.addEventListener){var b=[];window.addEventListener("message",function(e){var k=e.source;k!==window&&null!==k||"process-tick"!==e.data||(e.stopPropagation(),0<b.length&&b.shift()())},!0);return function(e){b.push(e);window.postMessage("process-tick","*")}}return function(b){setTimeout(b,0)}}();p.title="browser";
p.browser=!0;p.env={};p.argv=[];p.on=b;p.once=b;p.off=b;p.emit=b;p.binding=function(b){throw Error("process.binding is not supported");};p.cwd=function(){return"/"};p.chdir=function(b){throw Error("process.chdir is not supported");}},{}],7:[function(p,v,l){(function(b){function e(a,b){for(var d=0,h=a.length-1;0<=h;h--){var c=a[h];"."===c?a.splice(h,1):".."===c?(a.splice(h,1),d++):d&&(a.splice(h,1),d--)}if(b)for(;d--;d)a.unshift("..");return a}function k(a,b){if(a.filter)return a.filter(b);for(var d=
[],h=0;h<a.length;h++)b(a[h],h,a)&&d.push(a[h]);return d}var r=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;l.resolve=function(){for(var a="",d=!1,n=arguments.length-1;-1<=n&&!d;n--){var t=0<=n?arguments[n]:b.cwd();if("string"!==typeof t)throw new TypeError("Arguments to path.resolve must be strings");t&&(a=t+"/"+a,d="/"===t.charAt(0))}a=e(k(a.split("/"),function(a){return!!a}),!d).join("/");return(d?"/":"")+a||"."};l.normalize=function(a){var b=l.isAbsolute(a),n="/"===d(a,-1);
(a=e(k(a.split("/"),function(a){return!!a}),!b).join("/"))||b||(a=".");a&&n&&(a+="/");return(b?"/":"")+a};l.isAbsolute=function(a){return"/"===a.charAt(0)};l.join=function(){var a=Array.prototype.slice.call(arguments,0);return l.normalize(k(a,function(a,b){if("string"!==typeof a)throw new TypeError("Arguments to path.join must be strings");return a}).join("/"))};l.relative=function(a,b){function d(a){for(var c=0;c<a.length&&""===a[c];c++);for(var f=a.length-1;0<=f&&""===a[f];f--);return c>f?[]:a.slice(c,
f-c+1)}a=l.resolve(a).substr(1);b=l.resolve(b).substr(1);for(var h=d(a.split("/")),c=d(b.split("/")),f=Math.min(h.length,c.length),G=f,u=0;u<f;u++)if(h[u]!==c[u]){G=u;break}f=[];for(u=G;u<h.length;u++)f.push("..");f=f.concat(c.slice(G));return f.join("/")};l.sep="/";l.delimiter=":";l.dirname=function(a){var b=r.exec(a).slice(1);a=b[0];b=b[1];if(!a&&!b)return".";b&&(b=b.substr(0,b.length-1));return a+b};l.basename=function(a,b){var d=r.exec(a).slice(1)[2];b&&d.substr(-1*b.length)===b&&(d=d.substr(0,
d.length-b.length));return d};l.extname=function(a){return r.exec(a).slice(1)[3]};var d="b"==="ab".substr(-1)?function(a,b,d){return a.substr(b,d)}:function(a,b,d){0>b&&(b=a.length+b);return a.substr(b,d)}}).call(this,p("node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"))},{"node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":6}],8:[function(p,v,l){function b(){this._array=[];this._set=Object.create(null)}var e=p("./util"),
k=Object.prototype.hasOwnProperty;b.fromArray=function(e,d){for(var a=new b,h=0,n=e.length;h<n;h++)a.add(e[h],d);return a};b.prototype.size=function(){return Object.getOwnPropertyNames(this._set).length};b.prototype.add=function(b,d){var a=e.toSetString(b),h=k.call(this._set,a),n=this._array.length;h&&!d||this._array.push(b);h||(this._set[a]=n)};b.prototype.has=function(b){b=e.toSetString(b);return k.call(this._set,b)};b.prototype.indexOf=function(b){var d=e.toSetString(b);if(k.call(this._set,d))return this._set[d];
...
a.handleUncaughtExceptions:1)&&"object"===typeof b&&null!==b&&"function"===typeof b.on&&(C=!0,u())}}).call(this,p("node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js"),p("buffer").Buffer)},{"node_modules/browserify/node_modules/insert-module-globals/node_modules/process/browser.js":6,buffer:3,fs:2,module:2,path:7,"source-map":18}]},{},[1]);return N});
