...
import com.example.cliente.udemyandroidcero.Adapters.AnimalAdapter;
import com.example.cliente.udemyandroidcero.Adapters.ImagesAdapter;
import com.example.cliente.udemyandroidcero.Adapters.PartyAdapter;
...
public class PicassoActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewPicasso);
    ...
    {
        int[] values = {
                R.drawable.generic_no_image,
                R.drawable.green_lantern,
                R.drawable.movie_300,
                R.drawable.optimus300x209,
                R.drawable.superman_man_of_steel,
                R.drawable.terminator_movie,
                R.drawable.transformers_dark
        };
        return values;
    }
    ...
    public List<String> getImagesPath()
    {
        ...
        if(hasPermission(Manifest.permission.READ_EXTERNAL_STORAGE))
        {
            ...
            Cursor cursor = getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, columns, null, null, MediaStore.Images.Media._ID);
